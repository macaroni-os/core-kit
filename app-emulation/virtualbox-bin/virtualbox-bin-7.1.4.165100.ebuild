...
SRC_URI=" https://download.virtualbox.org/virtualbox/7.1.4/VirtualBox-7.1.4-165100-Linux_amd64.run -> VirtualBox-7.1.4-165100-Linux_amd64.run https://download.virtualbox.org/virtualbox/7.1.4/Oracle_VirtualBox_Extension_Pack-7.1.4.vbox-extpack -> Oracle_VM_VirtualBox_Extension_Pack-7.1.4-165100.tar.gz
...
src_unpack() {
	...
	unpack Oracle_VM_VirtualBox_Extension_Pack-7.1.4-165100.tar.gz
	popd &>/dev/null || die
