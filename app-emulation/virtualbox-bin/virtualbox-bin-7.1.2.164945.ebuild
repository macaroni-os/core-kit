...
SRC_URI=" https://download.virtualbox.org/virtualbox/7.1.2/VirtualBox-7.1.2-164945-Linux_amd64.run -> VirtualBox-7.1.2-164945-Linux_amd64.run https://download.virtualbox.org/virtualbox/7.1.2/Oracle_VirtualBox_Extension_Pack-7.1.2.vbox-extpack -> Oracle_VM_VirtualBox_Extension_Pack-7.1.2-164945.tar.gz
...
src_unpack() {
	...
	unpack Oracle_VM_VirtualBox_Extension_Pack-7.1.2-164945.tar.gz
	popd &>/dev/null || die
