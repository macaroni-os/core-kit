...
SRC_URI=" https://download.virtualbox.org/virtualbox/7.1.0/VirtualBox-7.1.0-164728-Linux_amd64.run -> VirtualBox-7.1.0-164728-Linux_amd64.run https://download.virtualbox.org/virtualbox/7.1.0/Oracle_VirtualBox_Extension_Pack-7.1.0.vbox-extpack -> Oracle_VM_VirtualBox_Extension_Pack-7.1.0-164728.tar.gz
...
src_unpack() {
	...
	unpack Oracle_VM_VirtualBox_Extension_Pack-7.1.0-164728.tar.gz
	popd &>/dev/null || die
