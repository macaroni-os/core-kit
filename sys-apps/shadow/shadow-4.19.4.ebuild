...
SRC_URI="https://api.github.com/repos/shadow-maint/shadow/tarball/refs/tags/4.19.4 -> shadow-4.19.4-115f7aa.tar.gz"

LICENSE="BSD GPL-2"
SLOT="0"
KEYWORDS="*"
IUSE="acl audit +cracklib nls pam selinux skey systemd xattr"
